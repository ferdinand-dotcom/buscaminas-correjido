...
public class Buscaminas {
    ...
    private void manejarAccion(int fila, int columna, JButton boton) {
        ...
        casilla.descubrir(); // Marcar como descubierta
        ...
        if (casilla.tieneMina()) {
            ...
            // Mostrar el número de minas adyacentes si no tiene mina
            if (casilla.getNumeroMinasAdyacentes() == 0) {
                boton.setText(""); // Casillas sin minas adyacentes no muestran texto
            } else {
